...
addLoadEvent( function() {
	theFileList = {
		...
		grabImageData: function(id) {
			...
			this.currentImage.src = ( 0 == id ? '' : $('attachment-postsize-url-' + id).value );
			this.currentImage.srcBase = ( 0 == id ? '' : $('attachment-url-base-' + id).value );
			this.currentImage.postsrc = ( 0 == id ? '' : $('attachment-postsize-url-' + id).value );
			this.currentImage.postsrcBase = ( 0 == id ? '' : $('attachment-url-base-' + id).value );
		...
		imageView: function(id, e) {
			...
			if ( 1 == this.currentImage.isImage ) {
				...
				if ( this.currentImage.thumb ) {
					...
					checked = 'display-post';
				}
				display.push("<label for='display-post'><input type='radio' name='display' id='display-post' value='post' /> <?php echo attribute_escape(__('Post size')); ?></label>");
			...
			h += "<label for='link-file'><input type='radio' name='link' id='link-file' value='file' /> <?php echo attribute_escape(__('File')); ?></label><br />";
			h += "<label for='link-page'><input type='radio' name='link' id='link-page' value='page' checked='checked' /> <?php echo attribute_escape(__('Page')); ?></label><br />";
